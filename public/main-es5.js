    ...
    var FileService = /*#__PURE__*/function () {
      ...
      _createClass(FileService, [{
        ...
        value: function currentImage(photoID) {
          return this.http.put("api/update_current/".concat(photoID), photoID);
        }
      }, {
        key: "deleteImage",
        value: function deleteImage(photoID) {
          return this.http["delete"]("api/delete_photo/".concat(photoID));
        }
      }, {
        key: "postBio",
        ...
        value: function editBio(bio) {
          return this.http.put("api/update_bio/".concat(bio), bio);
        }
      }]);
    ...
    var GService = /*#__PURE__*/function () {
      ...
      _createClass(GService, [{
        ...
        value: function editGetme(getme) {
          ...
          return this.http.put("api/editgetme/".concat(getme._id), getme, httpOptions);
        }
      }, {
        key: "deleteGetme",
        value: function deleteGetme(id) {
          //let httpOptions = { headers: new HttpHeaders({'Content-Type': 'application/json'})};
          return this.http["delete"]("api/deletegetme/".concat(id));
        }
      }]);

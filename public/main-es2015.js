...
NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavbarComponent, selectors: [["app-navbar"]], decls: 14, vars: 4, consts: [[1, "navbar", "navbar-light", "bg-light"], [1, "container"], [3, "routerLink"], [1, "dropdown"], ["class", "btn btn-secondary dropdown-toggle", "type", "button", "id", "dropdownMenuButton", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 4, "ngIf"], ["aria-labelledby", "dropdownMenuButton", 1, "dropdown-menu"], ["href", "https://fierce-gorge-54255.herokuapp.com/auth/google", 1, "dropdown-item"], ["href", "https://fierce-gorge-54255.herokuapp.com/auth/facebook", 1, "dropdown-item"], ["href", "https://fierce-gorge-54255.herokuapp.com/auth/twitter", 1, "dropdown-item"], ["class", "logout", 4, "ngIf"], ["type", "button", "id", "dropdownMenuButton", "data-toggle", "dropdown", "aria-haspopup", "true", "aria-expanded", "false", 1, "btn", "btn-secondary", "dropdown-toggle"], [1, "logout"], ["href", "#", 3, "click"]], template: function NavbarComponent_Template(rf, ctx) { if (rf & 1) {
...
class FileService {
    ...
    currentImage(photoID) {
        return this.http.put(`update_current/${photoID}`, photoID);
    }
    deleteImage(photoID) {
        return this.http.delete(`delete_photo/${photoID}`);
    }
    postBio(bio) {
        ...
        return this.http.post('bio', { bio: bio }, httpOptions);
    }
    editBio(bio) {
        return this.http.put(`update_bio/${bio}`, bio);
    }
}
...
class GService {
    ...
    editGetme(getme) {
        let httpOptions = { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/json' }) };
        return this.http.put(`editgetme/${getme._id}`, getme, httpOptions);
    }
    deleteGetme(id) {
        //let httpOptions = { headers: new HttpHeaders({'Content-Type': 'application/json'})};
        return this.http.delete(`deletegetme/${id}`);
    }
}
